...
function Quantity({getCount, currentQuantity, data, isPoint}: IQuantity) {
  ...
  return (
      <div className={"rounded-xl bg-[#EEEEEE] h-[30px] md:h-[48px] w-full flex items-center"}>
        <div className={"rounded-[10px] bg-[#EEEEEE] h-full w-full py-0 md:py-1 pl-0 mr-0 md:pl-6 md:pr-1 flex items-center"}>
          <p className={"text-[#383838b3] text-base mr-6 hidden md:flex"}>Quantity</p>

          <div className={"flex h-full items-center bg-[white] rounded-[10px] px-[16px]"}>
            ...
            <div className={"flex flex-col w-full justify-center items-center text-center mx-6"}>
