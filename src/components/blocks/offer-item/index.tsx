      ...
      <Link href={`/company/${companySlug}/voucher/${voucherSlug}`} style={{}}>
        <div style={{
          ...
          <div
            ...
            <p
              className={"text-clip overflow-hidden text-start sm:mt-3 mt-2 sm:font-bold font-[500] leading-[27px] text-[#383838] sm:text-[22px] text-base min-h-[54px] textDots2 aveSofBold"}>
            ...
            <p
              className={"text-[#38383899] text-start text-base leading-[23px] font-[400] sm:mt-[14px] mt-1 textDots2 min-h-[47px] aveSofRegular"}>
